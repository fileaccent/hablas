...
void hablas_strmv_copy_kernel(int32_t M,
                              ...
                              __gm__ float *workspace)
{
    ...
    int32_t loop_tmpw = M / cont_tmpw;
    int32_t remain_tmpw = M % cont_tmpw;
    ...
    if (incx == 1) {
        ...
        for (int32_t w_idx = 0; w_idx < loop_tmpw; ++w_idx) {
            ...
            int32_t loop_tmpx =  (cont_tmpw * incx) / cont_tmpx;
            int32_t remain_tmpx = (cont_tmpw * incx) % cont_tmpx;
